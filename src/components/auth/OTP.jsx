...
const OTP = () => {
    ...
    return (
        <div className='m-5'>
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8  text-gray-800 m-auto">
                ...
                <form action="" onSubmit={handleOTPSubmit} className="space-y-10">
                        ...
                        <div className="space-y-2 flex justify-center gap-4">
                            {['otp1', 'otp2', 'otp3', 'otp4'].map((name, index) => (
                                <input
                                    ...
                                    required
                                    maxLength={1}
                                    className="w-12 px-3 mt-2 py-3.5 text-center border rounded-md border-gray-500 bg-gray-300 text-gray-900 focus:border-violet-400"
                                />
                            ))}
                        </div>
                    </div>
                    ...
                    <button type="submit" className="w-full px-8 py-3 my-10 font-semibold rounded-md dark:bg-yellow-500 dark:text-gray-800">Verify OTP</button>
                    ...
                    <p className="text-sm text-center dark:text-gray-400">Don't have an account?
                        <a href="/" rel="noopener noreferrer" className="focus:underline text-yellow-500 hover:underline">Sign up here</a>
                    </p>
                </form>
            </div>
        </div>
